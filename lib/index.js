...
clear_1["default"]();
console.log(chalk_1["default"].blueBright(figlet_1["default"].textSync("local-sync", { horizontalLayout: "full" })));
commander_1.program
    .version("0.0.1")
...
var configFile = commander_1.program.config || "./local-sync.json";
        ...
        switch (_a.label) {
            case 0:
                ...
                config.syncers.forEach(function (syncer) {
                    var differences = sync_1.diffLocalChanges(syncer);
...
var run = function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, checkPackages()];
            case 1:
                _a.sent();
                log("\u2714 Local package.json looks good");
                return [4 /*yield*/, checkLocalChanges()];
            case 2:
                _a.sent();
                log("\u2714 Local files are synced");
                return [4 /*yield*/, startSync()];
            case 3:
                watchers = _a.sent();
                return [2 /*return*/];
        }
